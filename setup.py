...
setup(
    ...
    description='A Personal Finance Dashboard Project',
    #long_description=long_description,

    # The project's main homepage.
    url='https://github.com/dgoodburn/Project',

    # Author details
    author='Dan Goodburn',
    author_email='dgoodburn@me.com',
    ...
    keywords='personal finance dashboard international currency',
